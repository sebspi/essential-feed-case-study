...
//  Essential FeedTests
//
//  Created by Sebastian Spies on 10.03.22.
//
...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    func test_save_doesNotDeliverInsertionErrorErrorAfterSUTInstanceHasBeedDeallocated() {
    ...
    func test_save_doesNotDeliverDeletionErrorAfterSUTInstanceHasBeedDeallocated() {
        let store = FeedStoreSpy()
        var sut: LocalFeedLoader? = LocalFeedLoader(store: store, currentDate: Date.init)
